...
<?php
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        ...
        <div class="pd-10 d-flex justify-content-center"><span>Edição De Usuário</span></div>
  ...
  <script>
    ...
    <form name="form1" method="post" action="./editUser_php.php" onsubmit="return validateForm()" style="padding-top: 10%;">
