...
CREATE TABLE VOOS (
    ID_VOO INT(50) PRIMARY KEY AUTO_INCREMENT,
    DESTINO VARCHAR(100),
    DATA_IDA VARCHAR(50),
...
CREATE TABLE BAGAGENS (
    ...
    FK_PASSAGEM_ID_PASSAGEM INT(50)
);
...
ALTER TABLE BAGAGENS ADD CONSTRAINT FK_BAGAGENS_3
