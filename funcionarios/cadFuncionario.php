...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        ...
        <div class="pd-10 d-flex justify-content-center"><span>Cadastro De Funcionarios</span></div>
  ...
  <form name="form1" method="post" action="cadFuncionario_php.php" onsubmit="return validateForm()" style="padding-top: 10% ;">
    <div id="conteinercadFuncionario">
            ...
            <div class="col">
              <div class="h-100 w-100 d-flex justify-content-center align-items-center">
                <div class="input" id="senha">
                  ...
                  <h5>
                    A senha deve ter conter 6 caracteres, números e caracter
                    especial
                  </h5>
                </div>
              </div>
