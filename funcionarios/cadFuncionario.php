...
<body>
  <div class="logo">
    <a href="../index/index.php"><img id="Logo" href="../index/index.php" src="../imagens/flyboardLOGOremovido.png" alt="Logo" /></a>
  </div>
  <div id="h3">
    <h3>Cadastro de funcionarios</h3>
  </div>
  <form name="form1" method="post" action="cadFuncionario_php.php" onsubmit="return validateForm()">
